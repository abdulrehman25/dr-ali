<table width="100%" style="text-align: center;margin: 50px 0;" cellpadding="10">
    <tr>
        <td>Hi Dima, your report is ready.</td>
    </tr>
    <tr>
        <td> 
    ...
    font-weight: 600;line-height: 28px;border: 0;transition: all .45s cubic-bezier(.25, .46, .45, .94);cursor: pointer;">Proceed with payment</button></td>
    </tr>
</table>
